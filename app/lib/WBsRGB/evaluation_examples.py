...
in_base = os.path.join(
    "../../src", "examples_from_datasets", "RenderedWB_Set1", "input"
)
gt_base = os.path.join(
    "../../src", "examples_from_datasets", "RenderedWB_Set1", "groundtruth"
)
metadata_base = os.path.join(
    "../../src", "examples_from_datasets", "RenderedWB_Set1", "metadata"
)
...
print(
    "DeltaE 2000: %0.2f, MSE= %0.2f, MAE= %0.2f, DeltaE 76= %0.2f\n"
...
in_base = os.path.join(
    "../../src", "examples_from_datasets", "RenderedWB_Set2", "input"
)
gt_base = os.path.join(
    "../../src", "examples_from_datasets", "RenderedWB_Set2", "groundtruth"
)
...
imgin = "19_F.JPG"
in_base = os.path.join("../../src", "examples_from_datasets", "Rendered_Cube+", "input")
gt_base = os.path.join(
    "../../src", "examples_from_datasets", "Rendered_Cube+", "groundtruth"
)
